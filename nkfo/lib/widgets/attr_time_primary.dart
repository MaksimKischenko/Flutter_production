...
class AttrTimePrimary extends StatefulWidget {
  ...
  @override
  _AttrTimePrimaryState createState() => _AttrTimePrimaryState();
}

class _AttrTimePrimaryState extends State<AttrTimePrimary> {
  ...
  Widget build(BuildContext context) => TextFormField(
    ...
    decoration: InputDecoration(
      ...
      suffixIcon: IconButton(
        splashRadius: 1,
        onPressed: !widget.editable? null:_showTimePicker,
    ...
    onSaved: (value) => widget.onSaved?.call(value?.toDateFormattedOnlyTime())
  );
