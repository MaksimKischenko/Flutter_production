...
part of 'get_job_part_param_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

JobPartParam _$JobPartParamFromJson(Map<String, dynamic> json) => JobPartParam(
...
Map<String, dynamic> _$JobPartParamToJson(JobPartParam instance) =>
    <String, dynamic>{
