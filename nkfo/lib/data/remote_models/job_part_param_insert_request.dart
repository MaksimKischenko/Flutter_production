...
part 'job_part_param_insert_request.g.dart';

@JsonSerializable()
class JobPartParamInsertRequest {
  ...
  factory JobPartParamInsertRequest.fromJson(Map<String, dynamic> json) => _$JobPartParamInsertRequestFromJson(json);

  Map<String, dynamic> toJson() => _$JobPartParamInsertRequestToJson(this);


  JobPartParamInsertRequest copyWith({
    int? jobPartParamId,
    int? jobPartId,
    String? name,
    String? isAutoInc,
