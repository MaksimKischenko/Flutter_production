...
part 'job_part_update_request.g.dart';

@JsonSerializable(includeIfNull: false)
class JobPartUpdateRequest {
  ...
  factory JobPartUpdateRequest.fromJson(Map<String, dynamic> json) => _$JobPartUpdateRequestFromJson(json);

  Map<String, dynamic> toJson() => _$JobPartUpdateRequestToJson(this);
