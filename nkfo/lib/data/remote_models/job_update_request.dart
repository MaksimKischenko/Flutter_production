...
part 'job_update_request.g.dart';
...
class JobUpdateRequest {
  ...
  factory JobUpdateRequest.fromJson(Map<String, dynamic> json) => _$JobUpdateRequestFromJson(json);

  Map<String, dynamic> toJson() => _$JobUpdateRequestToJson(this);

  JobUpdateRequest copyWith({
    String? name,
    DateTime? startDate,
    String? isOnce,
    int? isNvalue,
