...
ClaimsListRequest _$ClaimsListRequestFromJson(Map<String, dynamic> json) =>
    ClaimsListRequest(
      ...
      rowCount: json['RowCount'] == null
          ? null
          : RowCount.fromJson(json['RowCount'] as Map<String, dynamic>),
    );
...
Map<String, dynamic> _$ClaimsListRequestToJson(ClaimsListRequest instance) {
  ...
  val['Status'] = _$ClaimStatusEnumMap[instance.status]!;
...
RowCount _$RowCountFromJson(Map<String, dynamic> json) => RowCount(
      evalue: json['evalue'] as int,
      claimId: json['@ClaimId'] as int?,
    );

Map<String, dynamic> _$RowCountToJson(RowCount instance) {
  final val = <String, dynamic>{
