...
class NewClaimScreenBody extends StatefulWidget {
  ...
  @override
  _NewClaimScreenBodyState createState() => _NewClaimScreenBodyState();
}

class _NewClaimScreenBodyState extends State<NewClaimScreenBody> {
  ...
  Widget build(BuildContext context) => DismissOutside(
        child: BlocListener<NewClaimBloc, NewClaimState>(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        if ((data.selectedService?.needGenerateAccNum ?? 0) ==
                            0)
                          Padding(
