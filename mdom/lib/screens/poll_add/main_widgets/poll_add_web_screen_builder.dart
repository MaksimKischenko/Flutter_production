...
class PolAddWebScreenBuilder extends StatefulWidget {
  final Poll? poll;
  const PolAddWebScreenBuilder({required this.poll, super.key});

  @override
  State<PolAddWebScreenBuilder> createState() => _PolAddWebScreenBuilderState();
}

class _PolAddWebScreenBuilderState extends State<PolAddWebScreenBuilder> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<AddPollBloc, AddPollState>(
      ...
      child: WebDialogWindow(
        ...
        buttonTitle: widget.poll == null ? 'Создать' : 'Сохранить',
        onPressed: _validateAndSendForm,
        buttonActive: isCreateAvaiable,
        secondButtonTitle: widget.poll == null
            ? 'Создать и опубликовать'
            : 'Сохранить и опубликовать',
        secondButtonCallback: () => _validateAndSendForm(
          publish: true,
        ),
        secondButtonActive: isPublishAvaiable,
        createSecondButton: isPublishAvaiable,
        body: Form(
          key: _formKey,
          child: Padding(
                ...
                if (_questions.isNotEmpty)
                  ListView.separated(
                    ...
                    itemBuilder: (context, index) => QuestionTextField(
                      ...
                      onChanged: (value) => _onQuestionChanged(index, value),
