...
class EndDateRangePicker extends StatelessWidget {
  ...
  Widget build(BuildContext context) => TextFormField(
    ...
    decoration: InputDecoration(
      labelText: 'Окончание голосования',
      // TODO
      // labelText: context.t.screens.mdomPollsListFilters.endDateRangePicker.title,
      // hintText: hint,
      counterText: '',
      ...
      suffixIcon: Icon(
        ...
        color: AppStyles.mainColor.withOpacity(0.6),
      )
    ),
    // onChanged: (value) {
    //   try {
  ...
  void _onTap(BuildContext context) async {
    final value = await Navigation.toPeriodCustom(
      context: context,
      title: 'Окончание голосования',
      // TODO
      // title: t.screens.mdomPollsListFilters.endDateRangePicker.calendarModalTitle,
      dateFrom: from,
      dateTo: to,
    );
