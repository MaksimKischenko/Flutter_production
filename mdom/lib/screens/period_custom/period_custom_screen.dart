...
class PeriodCustomScreen extends StatefulWidget {
  final String? title;
  final DateTime? initialDateFrom;
  final DateTime? initialDateTo;

  const PeriodCustomScreen({
    Key? key,
    this.title,
  ...
  @override
  _PeriodCustomScreenState createState() => _PeriodCustomScreenState();
}

class _PeriodCustomScreenState extends State<PeriodCustomScreen> {
  ...
  Widget build(BuildContext context) => Scaffold(
        appBar: DialogTitleAction(
          text: widget.title ?? 'Выбрать период',
          // TODO
          // text: widget.title ?? context.t.screens.mdomPeriodCustom.title,
          action: IconButton(
                    ...
                    Container(
                      ...
                      child: SfDateRangePicker(
                        ...
                        initialSelectedRange:
                            PickerDateRange(_dateFrom, _dateTo),
