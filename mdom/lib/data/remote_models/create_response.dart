...
class MdomCreateResponseWrapper {
  ...
  factory MdomCreateResponseWrapper.fromJson(Map<String, dynamic> json) =>
      _$MdomCreateResponseWrapperFromJson(json);
...
class MdomCreateResponse {
  ...
  factory MdomCreateResponse.fromJson(Map<String, dynamic> json) =>
      _$MdomCreateResponseFromJson(json);
