...
class MdomLoginRequestWrapper {
  ...
  factory MdomLoginRequestWrapper.fromJson(Map<String, dynamic> json) =>
      _$MdomLoginRequestWrapperFromJson(json);
...
class MdomLoginRequest {
  ...
  factory MdomLoginRequest.fromJson(Map<String, dynamic> json) =>
      _$MdomLoginRequestFromJson(json);
