...
class AllServicesLoaded extends AllServicesState {
  ...
  final List<ServiceFilter> availableFilters;
  final List<FilterAttrRecord> appliedFilters;
  ...
  @override
  List<Object?> get props => [nameMaxLength, availableFilters, appliedFilters, services];
}
