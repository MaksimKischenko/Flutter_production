...
import 'package:helppay_web_app/widgets/widgets.dart' as widgets;
...
class _ChangePasswordScreenBodyState extends State<ChangePasswordScreenBody> {
  ...
  Widget build(BuildContext context) => WebDialogWindow(
        title: context.t.mobileScreens.changePassword.title,
        buttonTitle: context.t.mobileScreens.changePassword.saveButton,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      //     text: context
                      //         .t.mobileScreens.changePassword.saveButton,
                      //     onPressed: _onSaveTap,
                      //   ),
                      // ),
                      widgets.PasswordField(
                        controller: _oldPasswordController,
                        labelText: context.t.mobileScreens.changePassword
                            .oldPasswordField.title,
                        hintText: '',
                        onSaved: (text) {
                          _changePasswordData.oldPassword =
                              CoreConfig.passwordCrypter(text);
                        },
                        validator: (text) {
                          if (state.oldPassword !=
                              CoreConfig.passwordCrypter(text)) {
                            return context.t.mobileScreens.changePassword
                                .oldPasswordField.errors.incorrect;
                          }
                          return null;
                        },
                      ),
                      ...
                      widgets.PasswordField(
                        ...
                        validator: (text) {
                          if (_newPasswordController.text !=
                            ...
                            return context.t.mobileScreens.changePassword
                                .newPasswordField.errors.passwordsNotMatch;
                          }
                          return null;
                        },
                      ),
  ...
  void _onSaveTap() {
    if (_changePasswordFormKey.currentState?.validate() ?? false) {
      ...
      context.read<ChangePasswordBloc>().add(ChangePasswordAction(
