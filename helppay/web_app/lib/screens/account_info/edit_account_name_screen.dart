...
class EditAccountNameScreen extends StatefulWidget {
  static const PageInfo<dynamic> routePage = PageInfo('/editAccountName');

  static const pageRoute = '/editAccountName';
  ...
  @override
  _EditAccountNameScreenState createState() => _EditAccountNameScreenState();
}
  ...
  Widget build(BuildContext context) =>
      BlocListener<ProductsBloc, ProductsState>(
        ...
        child: WebDialogWindow(
          title: context.t.mobileScreens.accountInfo.title,
          onPressed: _onSaveTap,
          buttonTitle: context.t.mobileScreens.accountInfo.buttonTitle,
          buttonActive: true,
          useSpacer: false,
          body: Padding(
              ...
              child: ParamField(
                ...
                validator: (value) {
                  ...
                  if (value.length < minLength) {
                    return context
                        .t.mobileScreens.accountInfo.editName.paramField.errors
