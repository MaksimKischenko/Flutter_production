...
class _ServiceResultPageState extends State<ServiceResultPage> {
  ...
  bool get _showTitle => (widget.scrollController.hasClients)
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: NextButton(
              onPressed: _onPayTap,
              text: context.t.mobileScreens.payment.serviceResultPage.nextButton
            ),
          ),
          const SizedBox(height: 8),
        ],
  ...
  void _onPayTap() {
    // widget.scrollController.createScrollPosition(physics, context, oldPosition)
  }
}