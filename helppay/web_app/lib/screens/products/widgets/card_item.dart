// ignore_for_file: prefer_expression_function_bodies, must_be_immutable

import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:flutter_svg/svg.dart';
import 'package:helppay_core/helppay_core.dart';
import 'package:helppay_web_app/screens/payments_history_filters/widgets/widgets.dart';
import 'package:helppay_web_app/styles.dart';
import 'package:helppay_web_app/widgets/widgets.dart';
import 'package:string_mask/string_mask.dart';

void _log(dynamic message) => Logger.helpPayLog(message, name: 'card_item');
...
class CardItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    _log(
        'Is balance requested - ${context.read<ProductsBloc>().state.balanceRequested}');
    return is123Card
        ? Container(
            margin: margin,
