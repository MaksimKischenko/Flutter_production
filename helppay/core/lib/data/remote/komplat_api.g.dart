...
class _KomplatApi implements KomplatApi {
  ...
  @override
  Future<PsEripGetOperationHistoryResponseWrapper> getOperationHistoryRequest(
      PsEripGetOperationHistoryRequestWrapper body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
      r'Content-Type': 'application/json; charset=UTF-8'
    ...
    _data.addAll(body.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PsEripGetOperationHistoryResponseWrapper>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'application/json; charset=UTF-8',
    ...
    final value =
        PsEripGetOperationHistoryResponseWrapper.fromJson(_result.data!);
    return value;
  }

  @override
  Future<PsEripGetBalanceResponseWrapper> getBalanceReguest(
      PsEripGetBalanceRequestWrapper body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
      r'Content-Type': 'application/json; charset=UTF-8'
    ...
    _data.addAll(body.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PsEripGetBalanceResponseWrapper>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'application/json; charset=UTF-8',
    ...
    final value = PsEripGetBalanceResponseWrapper.fromJson(_result.data!);
    return value;
  }
