...
class _MdomApi implements MdomApi {
  ...
  Future<MdomDeleteUserResponseWrapper> deleteUserRequest(
      MdomDeleteUserRequestWrapper body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
      r'Content-Type': 'application/json; charset=UTF-8'
    ...
    _data.addAll(body.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<MdomDeleteUserResponseWrapper>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'application/json; charset=UTF-8',
    ...
    final value = MdomDeleteUserResponseWrapper.fromJson(_result.data!);
    return value;
  }
  ...
  Future<MdomResetPasswordResponseWrapper> resetPasswordRequest(
      MdomResetPasswordRequestWrapper body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
      r'Content-Type': 'application/json; charset=UTF-8'
    ...
    _data.addAll(body.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<MdomResetPasswordResponseWrapper>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'application/json; charset=UTF-8',
    ...
    final value = MdomResetPasswordResponseWrapper.fromJson(_result.data!);
    return value;
  }

  @override
  Future<MdomRefreshTokenResponseWrapper> refreshTokenRequest(
      MdomRefreshTokenRequestWrapper body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
      r'Content-Type': 'application/json; charset=UTF-8'
    ...
    _data.addAll(body.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<MdomRefreshTokenResponseWrapper>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'application/json; charset=UTF-8',
    ...
    final value = MdomRefreshTokenResponseWrapper.fromJson(_result.data!);
    return value;
  }
