...
class MdomTpIntQuestionAnswersListResponseWrapper {
  ...
  factory MdomTpIntQuestionAnswersListResponseWrapper.fromJson(Map<String, dynamic> json) => _$MdomTpIntQuestionAnswersListResponseWrapperFromJson(json);

  Map<String, dynamic> toJson() => _$MdomTpIntQuestionAnswersListResponseWrapperToJson(this);
...
class MdomTpIntQuestionAnswersListResponse {
  ...
  factory MdomTpIntQuestionAnswersListResponse.fromJson(Map<String, dynamic> json) => _$MdomTpIntQuestionAnswersListResponseFromJson(json);

  Map<String, dynamic> toJson() => _$MdomTpIntQuestionAnswersListResponseToJson(this);
...
class QuestionAnswersListResponse {
  ...
  factory QuestionAnswersListResponse.fromJson(Map<String, dynamic> json) => _$QuestionAnswersListResponseFromJson(json);
...
class QuestionAnswersListQuestion {
  ...
  factory QuestionAnswersListQuestion.fromJson(Map<String, dynamic> json) => _$QuestionAnswersListQuestionFromJson(json);
...
class QuestionAnswersListQuestionAnswer {
  ...
  factory QuestionAnswersListQuestionAnswer.fromJson(Map<String, dynamic> json) => _$QuestionAnswersListQuestionAnswerFromJson(json);

  Map<String, dynamic> toJson() => _$QuestionAnswersListQuestionAnswerToJson(this);
