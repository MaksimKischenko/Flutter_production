...
///
/// Built on 2023-09-25 at 12:02 UTC
...
enum AppLocale with BaseAppLocale<AppLocale, _TranslationsRu> {
	...
	@override final TranslationBuilder<AppLocale, _TranslationsRu> build;
...
// Path: <root>
class _TranslationsRu implements BaseTranslations<AppLocale, _TranslationsRu> {
	...
	@override final TranslationMetadata<AppLocale, _TranslationsRu> $meta;
...
class _TranslationsMobileScreensRu {
	...
	late final _TranslationsMobileScreensCardRegistrationRu cardRegistration = _TranslationsMobileScreensCardRegistrationRu._(_root);
...
// Path: mobileScreens.cardRegistration
class _TranslationsMobileScreensCardRegistrationRu {
	_TranslationsMobileScreensCardRegistrationRu._(this._root);

	final _TranslationsRu _root; // ignore: unused_field

	// Translations
	late final _TranslationsMobileScreensCardRegistrationParamsRu params = _TranslationsMobileScreensCardRegistrationParamsRu._(_root);
	String get nextButton => 'Далее';
	String get continueButton => 'Продолжить';
	String get successButton => 'Хорошо';
	String get closeButton => 'Закрыть';
	String get cancelButton => 'Отменить';
	String get addButton => 'Добавить';
	String get releaseButton => 'Выпустить';
}
...
// Path: mobileScreens.cardRegistration.params
class _TranslationsMobileScreensCardRegistrationParamsRu {
	_TranslationsMobileScreensCardRegistrationParamsRu._(this._root);

	final _TranslationsRu _root; // ignore: unused_field

	// Translations
	String get cardTitle => 'Карта БНБ-банка';
	String get bnbTitle => 'ОАО «БНБ-Банк»';
	String get difitalCard => 'Цифровая карта 1-2-3, BYN';
	String get currentCardsTitle => 'Текущие карты';
	String get title => 'Оформление карты';
	String get phone => 'Введите номер телефона';
	String get phoneField => 'Номер телефона';
	String get confirmationCodeField => 'Код подтверждения';
	String get indificationNumberField => 'Идентификационный номер';
	String get codeWordField => 'Кодовое слово';
	late final _TranslationsMobileScreensCardRegistrationParamsErrorValidationMessagesRu errorValidationMessages = _TranslationsMobileScreensCardRegistrationParamsErrorValidationMessagesRu._(_root);
	late final _TranslationsMobileScreensCardRegistrationParamsErrorsInfoMessaesRu errorsInfoMessaes = _TranslationsMobileScreensCardRegistrationParamsErrorsInfoMessaesRu._(_root);
	late final _TranslationsMobileScreensCardRegistrationParamsAgrement0Ru agrement0 = _TranslationsMobileScreensCardRegistrationParamsAgrement0Ru._(_root);
	late final _TranslationsMobileScreensCardRegistrationParamsAgrement1Ru agrement1 = _TranslationsMobileScreensCardRegistrationParamsAgrement1Ru._(_root);
	late final _TranslationsMobileScreensCardRegistrationParamsAgrement2Ru agrement2 = _TranslationsMobileScreensCardRegistrationParamsAgrement2Ru._(_root);
	late final _TranslationsMobileScreensCardRegistrationParamsAgrement3Ru agrement3 = _TranslationsMobileScreensCardRegistrationParamsAgrement3Ru._(_root);
	String get confirmCode => 'Введите код подтверждения\nиз SMS-сообщения';
	String get retryCodeTimer => 'Отправить код повторно можно будет через: ';
	String get retryCode => 'Отправить код повторно';
	String get idNumber => 'Идентификационный номер';
	String get idNumberDesctiption => '14-значный идентификационный номер\nможно найти на 33 странице паспорта\nгражданина Республики Беларусь, на лицевой\nстороне ID-карты или на 17 странице вида на\nжительство';
	String get codeWordTitle => 'Придумайте кодовое слово';
	String get codeWordDesctiption => 'Кодовое слово может содержать не более\n25 заглавных или строчных букв на латинице\nили кириллице без пробелов, цифр и\n специальных символов';
	String get successRegistrationCard => 'Карта готова!';
	String get successRegistrationCardDesctiption => 'Вы можете ее использовать уже сейчас';
}
...
// Path: mobileScreens.cardRegistration.params.errorValidationMessages
class _TranslationsMobileScreensCardRegistrationParamsErrorValidationMessagesRu {
	_TranslationsMobileScreensCardRegistrationParamsErrorValidationMessagesRu._(this._root);

	final _TranslationsRu _root; // ignore: unused_field

	// Translations
	String get validationPhone => 'Введите номер телефона';
	String get validationCode => 'Введите код подтверждения';
	String get validationIndification => 'Введите идентификационный номер';
	String get validationCodeWord => 'Введите кодовое слово';
	String get validationPhoneCorrect => 'Введите корректный номер телефона';
	String get validationIndificationCorrect => 'Введите корректный индификационный номер';
}

// Path: mobileScreens.cardRegistration.params.errorsInfoMessaes
class _TranslationsMobileScreensCardRegistrationParamsErrorsInfoMessaesRu {
	_TranslationsMobileScreensCardRegistrationParamsErrorsInfoMessaesRu._(this._root);

	final _TranslationsRu _root; // ignore: unused_field

	// Translations
	String get errorTitle => 'Что-то пошло не так';
	String get errorMessage => 'Обратитесь в центр клиентского сервиса БНБ-Банка по номеру +375 29 309-7-309';
	String get errorTitleMSI => 'Регистрация онлайн недоступна';
	String get errorTitleDesctiptionMSI => 'Для завершения регистрации, пожалуйста,\n посетите любое отделение БНБ-банка\nс документом, удостоверяющим личность';
}

// Path: mobileScreens.cardRegistration.params.agrement0
class _TranslationsMobileScreensCardRegistrationParamsAgrement0Ru {
	_TranslationsMobileScreensCardRegistrationParamsAgrement0Ru._(this._root);

	final _TranslationsRu _root; // ignore: unused_field

	// Translations
	String get agrementsTextSpan1 => 'Для быстрого оформления заявки в ОАО «БНБ-Банк» необходим ваш ';
	String get agrementsTextSpan2 => 'номер мобильного телефона и идентификационный номер. ';
	String get agrementsTextSpan3 => 'Нажимая «Продолжить», вы осуществляете передачу данных из приложения информационному ресурсу ОАО «БНБ-Банк».';
}

// Path: mobileScreens.cardRegistration.params.agrement1
class _TranslationsMobileScreensCardRegistrationParamsAgrement1Ru {
	_TranslationsMobileScreensCardRegistrationParamsAgrement1Ru._(this._root);

	final _TranslationsRu _root; // ignore: unused_field

	// Translations
	String get agrementsTextSpan1 => 'Ознакомлен(a) и принимаю условия ';
	String get agrementsTextSpan2 => 'Политики\nконфиденциальности ';
	String get agrementsTextSpan3 => 'и ';
	String get agrementsTextSpan4 => 'Политики обработки\nперсональных данных';
}

// Path: mobileScreens.cardRegistration.params.agrement2
class _TranslationsMobileScreensCardRegistrationParamsAgrement2Ru {
	_TranslationsMobileScreensCardRegistrationParamsAgrement2Ru._(this._root);

	final _TranslationsRu _root; // ignore: unused_field

	// Translations
	String get agrementsTextSpan1 => 'Соглашаюсь с  ';
	String get agrementsTextSpan2 => 'обработкой персональных данных';
}

// Path: mobileScreens.cardRegistration.params.agrement3
class _TranslationsMobileScreensCardRegistrationParamsAgrement3Ru {
	_TranslationsMobileScreensCardRegistrationParamsAgrement3Ru._(this._root);

	final _TranslationsRu _root; // ignore: unused_field

	// Translations
	String get agrementsTextSpan1 => 'Соглашаюсь с ';
	String get agrementsTextSpan2 => 'Правилами обслуживания\nфизических лиц';
}
...
class _TranslationsMobileScreensEn extends _TranslationsMobileScreensRu {
	...
	@override late final _TranslationsMobileScreensCardRegistrationEn cardRegistration = _TranslationsMobileScreensCardRegistrationEn._(_root);
...
// Path: mobileScreens.cardRegistration
class _TranslationsMobileScreensCardRegistrationEn extends _TranslationsMobileScreensCardRegistrationRu {
	_TranslationsMobileScreensCardRegistrationEn._(_TranslationsEn root) : this._root = root, super._(root);

	@override final _TranslationsEn _root; // ignore: unused_field

	// Translations
	@override late final _TranslationsMobileScreensCardRegistrationParamsEn params = _TranslationsMobileScreensCardRegistrationParamsEn._(_root);
	@override String get nextButton => 'Further';
	@override String get successButton => 'Ok';
	...
	@override String get releaseButton => 'Release';
}
...
// Path: mobileScreens.cardRegistration.params
class _TranslationsMobileScreensCardRegistrationParamsEn extends _TranslationsMobileScreensCardRegistrationParamsRu {
	_TranslationsMobileScreensCardRegistrationParamsEn._(_TranslationsEn root) : this._root = root, super._(root);

	@override final _TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get cardTitle => 'BNB bank card';
	@override String get bnbTitle => '«BNB-Bank»';
	@override String get difitalCard => 'Digital card 1-2-3, BYN';
	@override String get currentCardsTitle => 'Current cards';
	@override String get title => 'Card issuing';
	@override String get phone => 'Enter phone number';
	@override String get phoneField => 'Phone number';
	@override String get confirmationCodeField => 'Confirmation code';
	@override String get indificationNumberField => 'indification number ';
	@override String get codeWordField => 'Code word';
	@override late final _TranslationsMobileScreensCardRegistrationParamsErrorValidationMessagesEn errorValidationMessages = _TranslationsMobileScreensCardRegistrationParamsErrorValidationMessagesEn._(_root);
	@override late final _TranslationsMobileScreensCardRegistrationParamsErrorsInfoMessaesEn errorsInfoMessaes = _TranslationsMobileScreensCardRegistrationParamsErrorsInfoMessaesEn._(_root);
	@override late final _TranslationsMobileScreensCardRegistrationParamsAgrement0En agrement0 = _TranslationsMobileScreensCardRegistrationParamsAgrement0En._(_root);
	@override late final _TranslationsMobileScreensCardRegistrationParamsAgrement1En agrement1 = _TranslationsMobileScreensCardRegistrationParamsAgrement1En._(_root);
	@override late final _TranslationsMobileScreensCardRegistrationParamsAgrement2En agrement2 = _TranslationsMobileScreensCardRegistrationParamsAgrement2En._(_root);
	@override late final _TranslationsMobileScreensCardRegistrationParamsAgrement3En agrement3 = _TranslationsMobileScreensCardRegistrationParamsAgrement3En._(_root);
	@override String get confirmCode => 'Enter verification code\nfrom SMS message';
	@override String get retryCodeTimer => 'You can resend the code via: ';
	@override String get retryCode => 'Send code again';
	@override String get idNumber => 'An identification number';
	@override String get idNumberDesctiption => 'The 14-digit identification number\ncan be found on page 33 of the passport\nof a citizen of the Republic of Belarus, on the front\nside of the ID-card or on page 17 of the residence\npermit';
	@override String get codeWordTitle => 'Come up with a code word';
	@override String get codeWordDesctiption => 'The code word can contain no more than\n25 uppercase or lowercase letters in Latin\nor Cyrillic without spaces, numbers and\n special characters';
	@override String get successRegistrationCard => 'The card is ready!';
	@override String get successRegistrationCardDesctiption => 'You can use it now';
}
...
// Path: mobileScreens.cardRegistration.params.errorValidationMessages
class _TranslationsMobileScreensCardRegistrationParamsErrorValidationMessagesEn extends _TranslationsMobileScreensCardRegistrationParamsErrorValidationMessagesRu {
	_TranslationsMobileScreensCardRegistrationParamsErrorValidationMessagesEn._(_TranslationsEn root) : this._root = root, super._(root);

	@override final _TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get validationPhone => 'Enter phone number';
	@override String get validationCode => 'Enter confirmation code';
	@override String get validationIndification => 'Enter Indification number';
	@override String get validationCodeWord => 'Enter code word';
	@override String get validationPhoneCorrect => 'Please enter a valid phone number';
	@override String get validationIndificationCorrect => 'Please enter a valid identification number';
}

// Path: mobileScreens.cardRegistration.params.errorsInfoMessaes
class _TranslationsMobileScreensCardRegistrationParamsErrorsInfoMessaesEn extends _TranslationsMobileScreensCardRegistrationParamsErrorsInfoMessaesRu {
	_TranslationsMobileScreensCardRegistrationParamsErrorsInfoMessaesEn._(_TranslationsEn root) : this._root = root, super._(root);

	@override final _TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get errorTitle => 'Something went wrong';
	@override String get errorMessage => 'Contact the customer service center of BNB-Bank at +375 29 309-7-309';
	@override String get errorTitleMSI => 'Online registration not available';
	@override String get errorTitleDesctiptionMSI => 'To complete registration, please \n visit any branch of BNB Bank\nwith an identity document';
}

// Path: mobileScreens.cardRegistration.params.agrement0
class _TranslationsMobileScreensCardRegistrationParamsAgrement0En extends _TranslationsMobileScreensCardRegistrationParamsAgrement0Ru {
	_TranslationsMobileScreensCardRegistrationParamsAgrement0En._(_TranslationsEn root) : this._root = root, super._(root);

	@override final _TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get agrementsTextSpan1 => 'For quick registration of an application in BNB-Bank';
	@override String get agrementsTextSpan2 => 'mobile phone number and identification number.';
	@override String get agrementsTextSpan3 => 'By clicking \'Continue\', you transfer data from the application to the information resource of BNB-Bank.';
}

// Path: mobileScreens.cardRegistration.params.agrement1
class _TranslationsMobileScreensCardRegistrationParamsAgrement1En extends _TranslationsMobileScreensCardRegistrationParamsAgrement1Ru {
	_TranslationsMobileScreensCardRegistrationParamsAgrement1En._(_TranslationsEn root) : this._root = root, super._(root);

	@override final _TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get agrementsTextSpan1 => 'I have read and accept the terms ';
	@override String get agrementsTextSpan2 => 'Privacy\npolicy ';
	@override String get agrementsTextSpan3 => 'and ';
	@override String get agrementsTextSpan4 => 'Policies for processing\npersonal data';
}

// Path: mobileScreens.cardRegistration.params.agrement2
class _TranslationsMobileScreensCardRegistrationParamsAgrement2En extends _TranslationsMobileScreensCardRegistrationParamsAgrement2Ru {
	_TranslationsMobileScreensCardRegistrationParamsAgrement2En._(_TranslationsEn root) : this._root = root, super._(root);

	@override final _TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get agrementsTextSpan1 => 'I agree with ';
	@override String get agrementsTextSpan2 => 'processing of personal data';
}

// Path: mobileScreens.cardRegistration.params.agrement3
class _TranslationsMobileScreensCardRegistrationParamsAgrement3En extends _TranslationsMobileScreensCardRegistrationParamsAgrement3Ru {
	_TranslationsMobileScreensCardRegistrationParamsAgrement3En._(_TranslationsEn root) : this._root = root, super._(root);

	@override final _TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get agrementsTextSpan1 => 'I agree with ';
	@override String get agrementsTextSpan2 => 'Terms of Service\nIndividuals';
}
