...
import 'package:helppay/blocs/qr_history/qr_history_bloc.dart';
import 'package:helppay/screens/mdom_qr_history/widgets/widgets.dart';
      ...
      BlocBuilder<QrHistoryBloc, QrHistoryState>(
        builder: (context, state) {
          ...
          if (state is QrHistoryError) {
            ...
            if (isTokenError) {
              WidgetsBinding.instance.addPostFrameCallback(
                (_) => Multiplatform.onExpiredTokenScreenLock(context),
              );
            }
          }
