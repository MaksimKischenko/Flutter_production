...
class CardNumberField extends StatelessWidget {
  ...
  CardNumberField(
      {this.focusNode, this.onFieldSubmitted, required this.onSaved});
  ...
  Widget build(BuildContext context) => TextFormField(
        ...
        decoration: InputDecoration(
            labelText: context
                .t.mobileScreens.productAdd.cardForm.cardNumberField.tilte,
        ...
        validator: (cardNumber) {
          if (cardNumber?.isEmpty ?? true) {
            return context.t.mobileScreens.productAdd.cardForm.cardNumberField
                .errors.empty;
          }
          if (_cardNumberFormatter.getUnmaskedText().length < 16) {
            return context.t.mobileScreens.productAdd.cardForm.cardNumberField
                .errors.incorrectFormat;
          }
          return null;
        },
        onChanged: (cardNumber) => onFieldSubmitted?.call(cardNumber),
