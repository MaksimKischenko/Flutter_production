...
//             final _claimId = services[index].claimId;
//             final _total = services[index].total;
//             final _dateBegin = DateFormat('dd/MM/yyyy HH:mm:ss').parse(services[index].dateBegin ?? '01.01.2022');
//             final _dateEnd = DateFormat('dd/MM/yyyy HH:mm:ss').parse(services[index].dateEnd ?? '01.01.2022');
//             final _payAmount = services[index].payAmount;
