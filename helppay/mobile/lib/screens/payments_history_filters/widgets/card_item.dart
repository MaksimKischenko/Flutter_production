...
class CardItem extends StatelessWidget {
  ...
  CardItem({
    ...
    cardNumber = StringMask('0000 0000 0000 0000').apply(item.params.findByAlias(AliasList.number)?.evalue);

    cardExpirationDate = StringMask('90/90').apply(item.params.findByAlias(AliasList.expirationDate)?.evalue);
