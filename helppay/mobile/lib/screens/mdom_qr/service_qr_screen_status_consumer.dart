...
import 'package:helppay/screens/mdom_qr/service_qr_screen_body.dart';
      ...
      child: BlocListener<QrRequestStatusBloc, QrRequestStatusState>(
        listener: (context, state) {
          if (state is QrRequestStatusErrorKomplat) {
            ...
            //   (_) => Multiplatform.showMessage(
            //     context: context,
            //     title: context.t.mobileScreens.qrPayment.paymentDialogTitle,
            //     message: state.infoMessage,
            //     type: DialogType.success,
            //   ),
            // );
            ...
            Multiplatform.showScrollableDialog<Widget>(
              context: context,
              builder: (context, controller) => StatusSuccessTransactionReceipt(
                state: state,
              ),
            );
