...
import 'package:helppay/screens/payment/widgets/widgets.dart';
...
class _AdditionInfoPageState extends State<AdditionInfoPage> {
  ...
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          ...
          title: _showTitle
              ?  Text(
                  context.t.mobileScreens.payment.fieldsPage.qrPayVerifyData.title,
            ...
            children: [
                ...
                child: SingleChildScrollView(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        PageTitle(
                            key: _titleKey, text: t.mobileScreens.payment.fieldsPage.qrPayVerifyData.title),
                        Form(
                            key: _formKey,
                            child: AttrField(
                              labelText: '${context.t.mobileScreens.payment.fieldsPage.qrPayVerifyData.accountNumber}*',
                              hintText: context.t.mobileScreens.payment.fieldsPage.qrPayVerifyData.accountNumber,
                              editable: true,
                              maxLength: 256,
                              validator: (value) {
                                if (value.isEmpty) {
                                  return context.t.mobileScreens.payment.fieldsPage.paramField.errors.empty;
                                }
                                return null;
                              },
                              onSaved: (value) {
                                widget.data = widget.data?.copyWith(
                                  accNum: value
                                );
                              },
                            )
              ...
              Padding(
                ...
                child: NextButton(
                    ...
                    text:context.t.mobileScreens.payment.fieldsPage.nextButton),
              )
            ],
          ),
        ),
