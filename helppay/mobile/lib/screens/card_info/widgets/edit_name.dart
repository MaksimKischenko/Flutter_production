...
class _EditNameState extends State<EditName> {
  ...
  @override
  Widget build(BuildContext context) => BlocListener<ProductsBloc, ProductsState>(
    ...
    child: CupertinoPageScaffold(
      navigationBar: DialogTitleAction(
        action: TextButton(
          ...
          child: Text(context.t.mobileScreens.cardInfo.editName.doneButton),
        ),
      ),
      child: Form(
        key: _paramsFormKey,
              ...
              ParamField(
                ...
                validator: (value) {
                  if (mandatory && value.isEmpty) {
                    return context.t.mobileScreens.cardInfo.editName.paramField.errors.empty;
                  }
                  if (!mandatory && value.isEmpty) return null;
                  if (value.length < minLength) {
                    return context.t.mobileScreens.cardInfo.editName.paramField.errors.minLength(minLength: minLength);
                  }
