...
import 'package:bpc_nkfo/utils/multiplatform.dart';
              ...
              defaultTargetPlatform == TargetPlatform.iOS
                  ? IconButton(
                    ...
                    onPressed: () async {
                      ...
                      if (result != null) onActionsTap.call(result);
                    }
                  )
                  : PopupMenuButton<DeviceActionType>(
                    ...
                    onSelected: (value) => Future<void>.delayed(const Duration(milliseconds: 300), () => onActionsTap.call(value))
                  ),
            ],
          ),
          Padding(
