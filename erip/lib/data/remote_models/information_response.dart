...
class PsTpOInformationResponseWrapper {
  ...
  factory PsTpOInformationResponseWrapper.fromJson(Map<String, dynamic> json) => _$PsTpOInformationResponseWrapperFromJson(json);

  Map<String, dynamic> toJson() => _$PsTpOInformationResponseWrapperToJson(this);
}
...
class PsTpOInformationResponse {
  ...
  factory PsTpOInformationResponse.fromJson(Map<String, dynamic> json) => _$PsTpOInformationResponseFromJson(json);
...
class InformationResponse {
  ...
  factory InformationResponse.fromJson(Map<String, dynamic> json) => _$InformationResponseFromJson(json);
...
class InformationResponseAccountStatement {
  ...
  factory InformationResponseAccountStatement.fromJson(Map<String, dynamic> json) => _$InformationResponseAccountStatementFromJson(json);

  Map<String, dynamic> toJson() => _$InformationResponseAccountStatementToJson(this);
...
class InformationResponseAccountStatementAccount {
  ...
  factory InformationResponseAccountStatementAccount.fromJson(Map<String, dynamic> json) => _$InformationResponseAccountStatementAccountFromJson(json);

  Map<String, dynamic> toJson() => _$InformationResponseAccountStatementAccountToJson(this);
