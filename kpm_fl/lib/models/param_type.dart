...
extension ParamTypeHelpExtension on ParamType {
  ...
  static const keyboardLayouts = <ParamType, KeyboardLayout>{
    ParamType.str: KeyboardLayout.text,
    ParamType.integ: KeyboardLayout.numeric,
    ParamType.doubl: KeyboardLayout.decimal,
  };

  KeyboardLayout get keyboardLayout => keyboardLayouts[this] ?? KeyboardLayout.text;
