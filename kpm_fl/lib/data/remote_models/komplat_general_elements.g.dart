...
AttrRecordResponse _$AttrRecordResponseFromJson(Map<String, dynamic> json) =>
    AttrRecordResponse(
      ...
      codeOut: AttrRecordResponse._codeOutFromJson(json['@CodeOut']),
...
Map<String, dynamic> _$PANToJson(PAN instance) {
...
Map<String, dynamic> _$TypePANToJson(TypePAN instance) {
  final val = <String, dynamic>{};
