...
class PayRecordResponse extends Equatable {
  ...
  @override
  List<Object?> get props => [code, name, recordType, stornoMode,
  ...
  date, attrRecord, lookups, check, claims];
...
class AttrRecordResponse extends Equatable {
  ...
  @JsonKey(name: '@CodeOut', fromJson: _codeOutFromJson)
  final int? codeOut;
  ...
  // TODO: remove this, change @CodeOut type to int in servlet
  static int? _codeOutFromJson(dynamic value) {
    int? ret;
    if (value is String) {
  ...
  maxLength, min, max, mandatory, edit, view, format, mask, value, change];
